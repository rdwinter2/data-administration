...
{
	if (region.a3.aj === region.bl.aj)
	{
		return 'on line ' + region.a3.aj;
	}
	return 'on lines ' + region.a3.aj + ' through ' + region.bl.aj;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.p, request.eb, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { c1: 'hidden', cF: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { c1: 'mozHidden', cF: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { c1: 'msHidden', cF: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { c1: 'webkitHidden', cF: 'webkitvisibilitychange' }
		: { c1: 'hidden', cF: 'visibilitychange' };
}
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{V: false, cv: r.cv, cS: r.cS, j: r.j, p: r.p, s: r.s, v: r.v, eb: r.eb}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{cv: elm$http$Http$emptyBody, cS: r.cS, j: _List_Nil, p: 'GET', s: elm$core$Maybe$Nothing, v: elm$core$Maybe$Nothing, eb: r.eb});
};
				...
				if (!res.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aK: 'Error: ' + author$project$Main$httpErrorToString(err)
							}),
						elm$core$Platform$Cmd$none);
				}
		}
...
var mdgriffith$elm_ui$Element$fromRgb = function (clr) {
	return A4(mdgriffith$elm_ui$Internal$Model$Rgba, clr.a0, clr.aT, clr.aR, clr.W);
};
var author$project$Main$uiColor = function (color) {
...
var mdgriffith$elm_ui$Internal$Style$classes = {cd: 'a', aO: 'atv', cg: 'ab', ch: 'cx', ci: 'cy', cj: 'acb', ck: 'accx', cl: 'accy', cm: 'acr', bb: 'al', bc: 'ar', cn: 'at', aP: 'ah', aQ: 'av', cp: 's', ct: 'bh', cu: 'b', cw: 'w7', cy: 'bd', cz: 'bdt', as: 'bn', cA: 'bs', at: 'cpe', cH: 'cp', cI: 'cpx', cJ: 'cpy', F: 'c', av: 'ctr', aw: 'cb', ax: 'ccx', G: 'ccy', ah: 'cl', ay: 'cr', cL: 'ct', cM: 'cptr', cN: 'ctxt', cZ: 'fcs', c_: 'fs', c$: 'g', aU: 'hbh', aB: 'hc', aV: 'hf', bs: 'hfp', c2: 'hv', c4: 'ic', c6: 'fr', c8: 'iml', c9: 'it', da: 'i', aa: 'nb', bE: 'notxt', dn: 'ol', dp: 'or', R: 'oq', du: 'oh', bI: 'pg', bJ: 'p', dv: 'ppe', dz: 'ui', x: 'r', dB: 'sb', dC: 'sbx', dD: 'sby', dE: 'sbt', dH: 'e', dI: 'cap', dJ: 'sev', dQ: 'sk', a6: 't', dU: 'tc', dV: 'w8', dW: 'w2', dX: 'w9', dY: 'tj', aL: 'tja', dZ: 'tl', d_: 'w3', d$: 'w5', d0: 'w4', d1: 'tr', d2: 'w6', d3: 'w1', d4: 'tun', b6: 'ts', T: 'clr', d9: 'u', a7: 'wc', ca: 'we', a8: 'wf', cb: 'wfp', a9: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.cp + (' ' + mdgriffith$elm_ui$Internal$Style$classes.F);
...
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.cp + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bI);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.cp + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bJ);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.cp + (' ' + mdgriffith$elm_ui$Internal$Style$classes.x);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.z)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dK.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dK.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.x) + ('-' + (elm$core$String$fromInt(pos.cK) + ('-' + (elm$core$String$fromInt(pos.af) + ('-' + elm$core$String$fromInt(pos._)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.c2, mdgriffith$elm_ui$Internal$Style$classes.T)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.c2, mdgriffith$elm_ui$Internal$Style$classes.R)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aO, mdgriffith$elm_ui$Internal$Style$classes.T)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aO, mdgriffith$elm_ui$Internal$Style$classes.R)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cp) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.x) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cp) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cp) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.x) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.cp) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.av) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {au: closing, i: _List_Nil, K: _List_Nil, C: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								i: A2(
									elm$core$List$cons,
									{au: '\n}', i: _List_Nil, K: props, C: '@supports (' + (prop + (':' + (value + (') {' + parent.C))))},
									rendered.i)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.C + ('{' + (renderValues(rule.K) + (rule.au + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.dI + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.a6 + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.dI + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.a6)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {_: height / size, a2: size, b8: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cE, adjustment.cs, adjustment.cP, adjustment.db]);
	var lineHeight = 1.5;
				...
				switch (rule.$) {
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.x) + (' / ' + (elm$core$String$fromInt(position.x + position._) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.cK) + (' / ' + (elm$core$String$fromInt(position.cK + position.af) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.x) + ('-' + (elm$core$String$fromInt(position.cK) + ('-' + (elm$core$String$fromInt(position.af) + ('-' + elm$core$String$fromInt(position._)))))));
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cp, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.G, mdgriffith$elm_ui$Internal$Style$classes.cm])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cp, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.G, mdgriffith$elm_ui$Internal$Style$classes.ck])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cp, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.cl])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.cp, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.av, mdgriffith$elm_ui$Internal$Style$classes.cj])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cp, mdgriffith$elm_ui$Internal$Style$classes.a6, mdgriffith$elm_ui$Internal$Style$classes.a7, mdgriffith$elm_ui$Internal$Style$classes.aB])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.cp, mdgriffith$elm_ui$Internal$Style$classes.a6, mdgriffith$elm_ui$Internal$Style$classes.a8, mdgriffith$elm_ui$Internal$Style$classes.aV])))
			]),
		_List_fromArray(
			[
...
var mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.b2 : _Utils_ap(styled.b2, existingStyles)) : _Utils_Tuple2(
							A2(
								elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.c3, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.b2 : _Utils_ap(styled.b2, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _n1.a;
			var styles = _n1.b;
			var newStyles = elm$core$List$isEmpty(styles) ? rendered.b2 : _Utils_ap(rendered.b2, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aa, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.cd]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aa, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.cu]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aa, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.dp]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aa, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.dn]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aa, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.c6]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aa, mdgriffith$elm_ui$Internal$Style$classes.dH, mdgriffith$elm_ui$Internal$Style$classes.ct]));
						}
					}())
				]),
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aP + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ch);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.cp + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.x + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.bs + (' height-fill-' + elm$core$String$fromInt(portion)))),
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.cp + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.F + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.b2);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var author$project$Main$myElement = A2(
	...
	_List_fromArray(
		[
			...
			author$project$Main$uiColor(avh4$elm_color$Color$purple)),
			mdgriffith$elm_ui$Element$Font$color(
			author$project$Main$uiColor(avh4$elm_color$Color$white)),
...
var danmarcab$material_icons$Material$Icons$Action$account_balance = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$d('M8 20v14h6V20H8zm12 0v14h6V20h-6zM4 44h38v-6H4v6zm28-24v14h6V20h-6zM23 2L4 12v4h38v-4L23 2z')
				]),
			_List_Nil)
		]));
...
var author$project$Main$myRowOfStuff = A2(
	...
	_List_fromArray(
		[
			author$project$Main$myElement,
			author$project$Main$myElement,
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_Nil,
			mdgriffith$elm_ui$Element$html(
				A2(danmarcab$material_icons$Material$Icons$Action$account_balance, avh4$elm_color$Color$orange, 48))),
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.dz, mdgriffith$elm_ui$Internal$Style$classes.cp, mdgriffith$elm_ui$Internal$Style$classes.dH]))),
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(
				author$project$Main$uiColor(avh4$elm_color$Color$lightGrey))
			]),
		author$project$Main$myRowOfStuff);
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bn: fragment, bt: host, bK: path, bM: port_, bP: protocol, bQ: query};
	});
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		...
		ec: function (m) {
			return {
				...
				d6: 'Elm 0.19 starter Raison D\'être'
			};
		}
	});
